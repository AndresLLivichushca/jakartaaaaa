...
a persistence unit "prueba3PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "prueba3/pom.xml":
...
artifact ("prueba3.war") is already built. You can build
